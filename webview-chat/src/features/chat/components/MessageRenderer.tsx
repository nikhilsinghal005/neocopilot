...
import '../../../shared/styles/themes/prism-tomorrow.css';
  ...
  const components: Components = {
    code({ inline, className, children, ...props }: CodeProps) {
      ...
      if (!inline && className && className.startsWith('language-')) {
        ...
        const dataSource = props.node && 'data' in props.node && props.node.data ? props.node.data.meta : "";
        const relativePath = getParams(dataSource ? dataSource.toString().trim() : "")
