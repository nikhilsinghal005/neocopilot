...
import { handleRemoveTagFunction } from '../../../features/chat/hooks/InputBarUtils';
...
const SelectedContextTags: React.FC = () => {
  ...
  return (
    <>
      {attachedContext.map((context: { fileName: string; filePath: string; isSelected: boolean; isManuallyAddedByUser: boolean; }, index: number) =>
