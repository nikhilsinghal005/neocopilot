...
export enum CodeSelectionCommand {
    codeFactor = 'extension.neoEdit',
    chatInsert = 'extension.neoChatInsert',
  }
...
export class SelectionContext {
    ...
    public createFixedHover(expandedRange: vscode.Range, selectedText: string): vscode.Hover | undefined {
        ...
        markdownContent.appendMarkdown(
            `[Insert in Chat(Ctrl+O)](command:${CodeSelectionCommand.chatInsert} "Talk to Code") | ` +
            `[Edit Inline(Ctrl+I)](command:${CodeSelectionCommand.codeFactor} "Edit Code")`
        );
